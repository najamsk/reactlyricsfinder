...
class Search extends Component {
    ...
    render(){
        return (
            <Consumer>
                {value => {
                    //console.log("search value prop=", value);
                            ...
                            <form onSubmit={this.findTrack.bind(this, dispatch)}>
                                <div className="form-group">
                                    <input type="text" className="form-control form-control-lg"
                                           placeholder="search by title" name="trackTitle" value={this.state.trackTitle} onChange={this.onChange} />
                                </div>
                                <button type="submit" className="btn btn-primary btn-lg btn-block mb-5">Get Lyrics</button>
                            </form>
                        </div>
                    );
                }} 
